...
//#define LED_TYPE_BOTTLE_ON       (if(LED_SWITCH_ON) P1OUT &= ~BIT6;)
#define LED_TYPE_BOTTLE_OFF      P1OUT |= BIT6

#define LED_TYPE_BAG_BLINK    P1OUT ^= BIT0
//#define LED_TYPE_BAG_ON();       (if(LED_SWITCH_ON) P1OUT &= ~BIT0;)
#define LED_TYPE_BAG_OFF      P1OUT |= BIT0

// sign led
#define LED_SIGN_BLINK      P4OUT ^= BIT3
//#define LED_SIGN_ON         if(LED_SWITCH_ON) P4OUT &= ~BIT3
